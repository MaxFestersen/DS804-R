...
accuracy <- sum(92+19+158+24+16)/length(compound.df$class)
accuracy
# Plotting Cluster
...
# Table
confused_matrix <- table(Dbscan_cl_shrek$cluster, classNames)
confused_matrix

cluster_report(confused_matrix, cap = "DBScan")
