...
have some trouble with the libs, the rain and the virus,
...
using more clusteres there than the others. It does get Libs and Left-eye right.

It has the best visual result, with the creation og a Mouth, Eyes and multicolored
Scenery.

From what we predicted, we correctly predicted some of the issues troubles.
Additionally we were supprised to see Tounge being split in some cases.
The eyes were also never classified correctly, with them being clusterd close
together and sometimes together with Libs and Tounge.
