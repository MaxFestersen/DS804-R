...
compound_target_category_shrek <- classNames#all data
compound_test_category_shrek <- classNames#all data
...
sqrt(399)
#KNN algorithm where key is equal to square root of total number of rows
predictions_shrek <- knn(compound_train_shrek,compound_test_shrek,cl=compound_target_category_shrek,use.all = TRUE, k=1)
...
panel.background = element_blank(), axis.line = element_line(colour = "black"))
#plot with border
border_plot+geom_polygon(data = boundary_shrek, aes(x,y), alpha = 0.5)+theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
panel.background = element_blank(), axis.line = element_line(colour = "black"))
