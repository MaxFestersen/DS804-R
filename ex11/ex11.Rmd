...
grid.arrange(c_har_won4plot1, c_har_won4plot2, ncol = 2)
...
grid.arrange(c_har_won5plot1, c_har_won5plot2, ncol = 2)
...
grid.arrange(c_har_wonplot1, c_har_wonplot2, ncol = 2)
...
grid.arrange(c_har_won7plot1, c_har_won7plot2, ncol = 2)
```
...
plot_stuff <- function(df, predicted, cap) {
  ggplot(df, aes(date, sentiment, shape = title, color = predicted)) +
    geom_point() +
    labs(title = cap) +
    theme_light()
}
