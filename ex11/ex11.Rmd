...
```{r 5.6.2 Silhouette Coefficient Shrek, warning=FALSE, echo=FALSE}
set.seed(42069)

# 4 clusters
c_har_won4 <- kmeans(data.points, 4)
sil_res4 <- silhouette(c_har_won4$cluster, dist(data.points))
c_har_won4plot1 <- fviz_cluster(c_har_won4, data = data.points,
             geom = "point",
             ellipse.type = "convex", 
             ggtheme = theme_bw()
             )
...
# 5 clusters
c_har_won5 <- kmeans(data.points, 5)
sil_res5 <- silhouette(c_har_won5$cluster, dist(data.points))
c_har_won5plot1 <- fviz_cluster(c_har_won5, data = data.points,
             geom = "point",
             ellipse.type = "convex", 
             ggtheme = theme_bw()
             )
...
# 6 clusters
c_har_won6 <- kmeans(data.points, 6)
sil_res6 <- silhouette(c_har_won6$cluster, dist(data.points))
c_har_wonplot1 <- fviz_cluster(c_har_won6, data = data.points,
             geom = "point",
             ellipse.type = "convex", 
             ggtheme = theme_bw()
             )
