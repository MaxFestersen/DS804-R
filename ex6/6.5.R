...
# >(b) Start a new R script containing your solutions. --------------------
# Save the script for later reference.
# You can use #### Section With Name #### To define a section within your script with name “Section
# With Name” in your R code, that you can easily navigate to.
print("This is the script.")
#### >>This section ####


# (c) Some important commands for learning R ------------------------------
